...
a persistence unit "eva62TapiaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Tapia/pom.xml":
...
artifact ("eva62Tapia.war") is already built. You can build
